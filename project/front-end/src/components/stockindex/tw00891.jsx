...
const GlassChart = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await axios.get("http://localhost:9453/glass", {});
    ...
    <>
      ...
      <div className={
        ...
        <div className="p-2 fs-5">
          00891中信關鍵半導體是台灣股市上市的股票基金，由中信投信管理，投資於半導體產業相關企業，受益於科技產業發展。投資者可透過交易所買賣，參與半導體行業成長機會，但需注意投資風險，建議諮詢專業金融顧問。
        </div>
      </div>
    </>
  );
