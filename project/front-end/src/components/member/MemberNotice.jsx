    ...
    return (
        <>
            <div className="px-4 py-3 me-5">
                <p className="text-IronGray-Deep fs-3 fw-bold pb-2 border-bottom">會員公告</p>
                        ...
                        <div
                            ...
                            <Col
                                ...
                                <a
                                    ...
                                    className={`line-cut-2 border-0 text-IronGray-Deep ${message.stats === 1 ? "text-IronGray-Light" : ""
                                        }`}>
                                    {message.message}
                                </a>
                            </Col>
