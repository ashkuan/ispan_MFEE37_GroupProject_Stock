  ...
  return (
    <div className="d-flex justify-content-center">
      <Nav
        ...
        className="flex-column pt-4 fs-5">
        <Nav.Link
          href="/member"
          className="nav-link d-flex justify-content-center align-items-center IronGray rounded-3 px-4 py-3 mb-2">
          <svg
          ...
          <span className="text-white">會員資訊</span>
        </Nav.Link>
        <Nav.Link
          href="/member/mail"
          className="nav-link d-flex justify-content-center align-items-center IronGray rounded-3 px-4 py-3 mb-2">
          ...
          <span className="text-white">會員公告</span>
        </Nav.Link>
        <Nav.Link
          href="/member/col"
          className="nav-link d-flex justify-content-center align-items-center IronGray rounded-3 px-4 py-3 mb-2">
        ...
        <Nav.Link
          ...
          <span className="text-white">我的文章</span>
        </Nav.Link>
        <button
